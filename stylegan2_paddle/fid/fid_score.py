...
FID_WEIGHTS_URL = 'https://paddlegan.bj.bcebos.com/InceptionV3.pdparams'
...
def inception_infer(x, model_path):
    ...
    [inference_program, feed_target_names, fetch_targets] = paddle.fluid.io.load_inference_model(model_path, exe)
